...
namespace tlcn_dotnet.IRepositories
{
    public interface ICartRepository
    {
        ...
        public Task<dynamic> GetUserCartHistory(long accountId, CartStatus? status, PaymentMethod? paymentMethod, DateTime? fromDate, DateTime? toDate,
        ...
        public Task<Cart> ProcessCartById(long id);
    }
}
